...
📱 Expanding into mobile development with React Native and Expo# 👋 Hi, I'm Kwame Dawson
...
* 🎓 Computer Science student at the **University of Ghana**
* 💻 Full-stack developer working primarily with the **MERN stack**
* 📱 Expanding into mobile development with **React Native & Expo**
* ⚛️ Building modern interfaces with **React, JavaScript, Vite & Tailwind CSS**
* 🔧 Building backend APIs and services with **Node.js, Express & MongoDB**
* 🔥 Exploring **Firebase Authentication, Firestore & Firebase-powered applications**
* 🚀 Learning how to take applications from development to production
* 🧠 Strengthening my understanding of **data structures, algorithms, databases & software engineering**
...
A full-stack personal portfolio with an integrated **admin-dashboard direction and content management**.

### 🏋️ FitForge

A workout planning application exploring **React, Tailwind CSS, Firebase Authentication, and Firestore**.

### ✅ Student Task Manager

A Java project for practicing **object-oriented programming and collection frameworks**.

### 🌐 Business Websites & Web Apps

Practical projects focused on helping **small businesses establish an online presence**.

### 📱 React Native / Expo Applications

Exploring the transition from web development into **cross-platform mobile development**.

---

# 💡 Development Philosophy

> *"Great software comes from clear thinking, consistent practice, and continuous improvement."*
...
**Fast · Scalable · Responsive · Maintainable · Genuinely Useful**
...
**It is the ability to turn imagination into reality.**
